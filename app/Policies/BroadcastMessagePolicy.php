...
class BroadcastMessagePolicy
{
     ...
     */
    public function view(User $user, BroadcastMessage $broadcastMessage): bool
    {
     ...
     */
    public function update(User $user, BroadcastMessage $broadcastMessage): bool
    {
     ...
     */
    public function delete(User $user, BroadcastMessage $broadcastMessage): bool
    {
     ...
     */
    public function forceDelete(User $user, BroadcastMessage $broadcastMessage): bool
    {
     ...
     */
    public function restore(User $user, BroadcastMessage $broadcastMessage): bool
    {
     ...
     */
    public function replicate(User $user, BroadcastMessage $broadcastMessage): bool
    {
